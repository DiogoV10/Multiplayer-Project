...
namespace V10
{
    public class CharacterSelectPlayer : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            int clientIndex = GameMultiplayer.Instance.GetPlayerDataIndexFromClientId(NetworkManager.Singleton.LocalClientId);

            kickButton.gameObject.SetActive(NetworkManager.Singleton.IsServer && clientIndex != playerIndex);
            UpdatePlayer();
        }
